...
import { AdministrationUserProjectComponent } from './admin/page/administration-user-project/administration-user-project.component';
...
export const routes: Routes = [
    ...
    { path: 'administration-user-project', component: AdministrationUserProjectComponent, canActivate: [authGuard] },
